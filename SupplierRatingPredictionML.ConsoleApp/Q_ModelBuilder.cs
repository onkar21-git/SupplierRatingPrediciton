...
namespace SupplierRatingPredictionML.ConsoleApp
{
    public class Q_ModelBuilder
    {
        ...
        private static string MODEL_FILEPATH = @"C:\Users\walavonk\Desktop\AI_Project\SourceCodeMain\Data\Q_MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTree(labelColumnName: "Quality_Rating", featureColumnName: "Features");
