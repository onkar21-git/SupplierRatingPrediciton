...
namespace SupplierRatingPredictionML.ConsoleApp
{
    public class C_ModelBuilder
    {
        ...
        private static string MODEL_FILEPATH = @"C:\Users\walavonk\Desktop\AI_Project\SourceCodeMain\Data\C_MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTree(labelColumnName: "Cost_Rating", featureColumnName: "Features");
